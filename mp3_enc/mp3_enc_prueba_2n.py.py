...
NOMBRE_PROGRAMA = "mp3_enc"  # Cambiado a mp3_enc
...
def ejecutar_simulacion(config, simulacion):
    ...
    # Llama al script de gem5 con los parámetros adecuados para mp3_enc
    command = [
    ...
    archivo_mp3 = os.path.join(carpeta_m5out, "mp3enc_outfile.mp3")
    archivo_estadisticas_gem5 = os.path.join(carpeta_m5out, "stats.txt")

    if os.path.exists(archivo_mp3):
        print(f"Archivo de salida encontrado: {archivo_mp3}")
    else:

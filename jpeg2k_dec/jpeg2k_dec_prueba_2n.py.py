...
def ejecutar_simulacion(config, simulacion):
    ...
    archivo_bmp = os.path.join(carpeta_m5out, "jpg2kdec_outfile.bmp")
    archivo_estadisticas_gem5 = os.path.join(carpeta_m5out, "stats.txt")

    if os.path.exists(archivo_bmp):
        print(f"Archivo de salida encontrado: {archivo_bmp}")
    else:
